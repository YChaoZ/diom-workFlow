...
import com.diom.flowable.dto.ProcessDesignDTO;
import com.diom.flowable.dto.PublishDTO;
import com.diom.flowable.dto.ValidateDTO;
import com.diom.flowable.entity.ProcessDesign;
import com.diom.flowable.entity.ProcessDesignHistory;
import com.diom.flowable.mapper.ProcessDesignHistoryMapper;
import com.diom.flowable.mapper.ProcessDesignMapper;
import com.diom.flowable.vo.ProcessDesignHistoryVO;
import com.diom.flowable.vo.ProcessDesignVO;
import com.diom.flowable.vo.ValidationResultVO;
...
public class ProcessDesignService {
    ...
    public ValidationResultVO validate(ValidateDTO dto) {
        ...
        try {
            // 使用 Flowable 的 BpmnXMLConverter 解析 BPMN XML
            BpmnXMLConverter converter = new BpmnXMLConverter();
            XMLInputFactory xif = XMLInputFactory.newInstance();
            XMLStreamReader xtr = xif.createXMLStreamReader(new StringReader(dto.getBpmnXml()));
            ...
            result.setStartEvents(startEventCount);
            result.setUserTasks(userTaskCount);
            result.setEndEvents(endEventCount);
