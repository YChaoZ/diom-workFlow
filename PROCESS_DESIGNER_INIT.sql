...
-- 3. 初始化现有流程数据（将已有的leave-approval-process迁移到表中）
-- 注意：这里需要手动替换完整的BPMN XML内容
...
<bpmn:definitions xmlns:bpmn="http://www.omg.org/spec/BPMN/20100524/MODEL" xmlns:bpmndi="http://www.omg.org/spec/BPMN/20100524/DI" xmlns:dc="http://www.omg.org/spec/DD/20100524/DC" xmlns:camunda="http://camunda.org/schema/1.0/bpmn" id="Definitions_1" targetNamespace="http://bpmn.io/schema/bpmn" exporter="Camunda Modeler" exporterVersion="5.0.0">
  <bpmn:process id="leave-approval-process" name="请假审批流程" isExecutable="true">
    ...
    <bpmn:sequenceFlow id="flow1" sourceRef="startEvent" targetRef="fillLeaveForm" />
    <bpmn:sequenceFlow id="flow2" sourceRef="fillLeaveForm" targetRef="managerApproval" />
    <bpmn:sequenceFlow id="flow3" sourceRef="managerApproval" targetRef="endEvent" />
  </bpmn:process>
</bpmn:definitions>',
...
-- ============================================
-- 初始化完成！
-- 验证：SELECT * FROM workflow_process_design;
-- 验证：SELECT * FROM workflow_process_design_history;
-- ============================================
